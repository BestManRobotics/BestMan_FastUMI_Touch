# FastUMITouch Python SDK

FastUMITouch 机械臂的 Python SDK，通过 CAN 总线与机械臂通信，提供关节控制、末端位姿控制和夹爪操作功能。
...
```bash
git clone https://github.com/write-for-bug/fastumitouch_sdk.git
cd fastumitouch_sdk
```
...
```python
arm = FastUMITouch(can_port="can0")  # can_port 默认为 "can0"
```
